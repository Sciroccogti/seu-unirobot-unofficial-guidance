...
namespace Leph
{
    ...
    public:
        ...
        VectorLabel(size_t size) :
            _eigenVector(Eigen::VectorXd::Zero(size)),
            _labelToIndex(nullptr),
            _indexToLabel(nullptr)
        {
            _labelToIndex = std::make_shared<LabelContainer>();
        ...
        VectorLabel(const LabelList &labels) :
            _eigenVector(Eigen::VectorXd::Zero(labels.size())),
            _labelToIndex(nullptr),
            _indexToLabel(nullptr)
        {
            _labelToIndex = std::make_shared<LabelContainer>();
        ...
        VectorLabel(const Eigen::VectorXd &vect) :
            _eigenVector(vect),
            _labelToIndex(nullptr),
            _indexToLabel(nullptr)
        {
         ...
         */
        inline const Eigen::VectorXd &vect() const
        {
            return _eigenVector;
        }
        inline Eigen::VectorXd &vect()
        {
            return _eigenVector;
        }
