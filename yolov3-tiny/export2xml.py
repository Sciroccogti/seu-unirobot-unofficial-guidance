...
target_dir = '.../darknet/scripts/VOCdevkit/VOC2019/Annotations/'
image_dir = '.../darknet/scripts/VOCdevkit/VOC2019/JPEGImages/'  # 图片文件夹
train_file = '.../export_1302.txt'  # 存储了图片信息的txt文件
 
fi = open('.../darknet/scripts/VOCdevkit/VOC2019/ImageSets/Main/train.txt',"w")
